...
begin
  ...
  begin
    ...
    begin
      ...
      { Buscar capacitación correspondiente }
      ...
      begin
        ...
        writeln('Condición: ', 
                (if regAlu.condicion = Aprobado then 'Aprobado' else 'Asistencia'));
        writeln('-------------------------------------------');
      end;
    end;
    posAlu := posAlu + 1;
  ...
  begin
    ...
    begin
      ...
      if (alu.codCapacitacion = codCap) and (alu.estado = activo) and
        ...
        writeln(alu.apenom:25, '   ', 
                (if alu.condicion = Aprobado then 'Aprobado' else 'Asistencia'));
      posAlu := posAlu + 1;
    end;
  end
  else
